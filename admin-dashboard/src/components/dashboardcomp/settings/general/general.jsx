    ...
    <div className="border border-slate-300 rounded-2xl p-5 flex flex-col gap-4">
      <div className="flex flex-col gap-2">
        ...
        <div className="flex items-center border border-slate-300 p-2 rounded-2xl gap-2">
          ...
          <input type="text" placeholder="Enter" className="border-none outline-none text-sm " />
        </div>
      </div>
      ...
      <div className="flex flex-col gap-2">
        ...
        <div>
          <select
            name=""
            id=""
            className=" border border-slate-300 p-2 rounded-2xl w-full outline-none text-sm"
          >
            ...
            <option value="frn" className="text-sm">
              French
            </option>
            <option value="kr" className="text-sm">
              Korean
            </option>
          </select>
        </div>
